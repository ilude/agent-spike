...
uv run python compose/cli/reprocess_qdrant_metadata.py --dry-run --limit 5

# Test lesson-010 tag normalization
uv run python compose/cli/reprocess_normalized_tags.py --dry-run --limit 3
...
Edit `compose/lib/reprocessing/transform_versions.py`:
...
uv run python compose/cli/reprocess_qdrant_metadata.py --dry-run --limit 10
...
uv run python compose/cli/reprocess_normalized_tags.py --no-context --limit 50
```
...
- See `compose/lib/reprocessing/transform_versions.py` for version registry
- See `compose/lib/reprocessing/metadata_transformers.py` for transformer pattern
- See `compose/lib/reprocessing/reprocessing_pipeline.py` for pipeline template
