...
class AsyncPatternTracker(Protocol):
    """Async protocol for URL pattern learning and analytics service.

    This protocol defines the async interface for tracking URL classifications,
    learning patterns, and managing re-evaluation of low-confidence URLs.

    Used by SurrealDB implementation which requires async operations.
    """
