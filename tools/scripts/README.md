...
| `ingest_video.py` | Single video ingestion | `uv run python tools/scripts/ingest_video.py "URL"` |
| `list_videos.py` | List cached videos | `uv run python tools/scripts/list_videos.py` |
| `verify_video.py` | Check specific video | `uv run python tools/scripts/verify_video.py VIDEO_ID` |
| `search_videos.py` | Semantic search | `uv run python tools/scripts/search_videos.py "query"` |
| `fetch_channel_videos.py` | Get channel videos → CSV | `uv run python tools/scripts/fetch_channel_videos.py "@channel"` |
...
# Direct invocation
uv run python tools/scripts/ingest_youtube.py [csv_path] [collection_name]
```
...
uv run python tools/scripts/fetch_channel_videos.py "https://www.youtube.com/@NateBJones"

# Specify output file
uv run python tools/scripts/fetch_channel_videos.py "https://www.youtube.com/@NateBJones" output.csv
```
...
from tools.services.your_service import your_function
