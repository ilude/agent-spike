...
from tools.services.archive import create_archive_manager
from tools.services.youtube.url_filter import filter_urls
...
def batch_reevaluate_low_confidence(pattern_tracker, archive_manager) -> None:
    ...
    Args:
        ...
        archive_manager: ArchiveManager instance
    """
    from tools.services.youtube.url_filter import classify_url_with_llm
